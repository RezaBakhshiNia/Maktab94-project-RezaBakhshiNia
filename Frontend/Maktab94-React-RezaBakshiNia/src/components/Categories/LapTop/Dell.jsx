        ...
        if (sortingType === "asc") {
          setProducts(
            response.data.data.products
              ...
              .filter((product) => product.brand === "Dell")
          );
      ...
      <div className="laptops-wrapper">
        <aside>
          <div className="filter-brand">
            <h4>برند:</h4>
            <div>
              <Link to={"/category/laptop/apple"}>اپل</Link>
              <Link to={"/category/laptop/asus"}>ایسوس</Link>
              <Link to={"/category/laptop/dell"}>دل</Link>
              <Link to={"/category/laptop/hp"}>HP</Link>
            </div>
          </div>
